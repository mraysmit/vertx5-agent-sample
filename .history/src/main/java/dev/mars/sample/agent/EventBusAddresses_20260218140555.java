...
/**
 * Default event bus address constants for inter-verticle communication.
 *
 * <p>These constants provide sensible default values. They are used only in
 * {@link MainVerticle} (the composition root); all other components receive
 * their addresses via constructor injection, making them fully reusable and
