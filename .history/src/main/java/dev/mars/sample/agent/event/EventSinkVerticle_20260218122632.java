...
/**
 * Simple consumer verticle that subscribes to {@link EventBusAddresses#EVENTS_OUT}
 ...
 *
 * @see EventBusAddresses#EVENTS_OUT
 */
public class EventSinkVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> startPromise) {
    vertx.eventBus().consumer(EventBusAddresses.EVENTS_OUT, msg -> {
