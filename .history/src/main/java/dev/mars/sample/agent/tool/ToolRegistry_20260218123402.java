 ...
 * agent runner.
 *
 * <p>Three factory methods support different composition patterns:
 * <ul>
 *   <li>{@link #defaultTools(Vertx)} — returns the built-in tool set for
 *       the trade-failure demo.</li>
...
public final class ToolRegistry {
  ...
  /**
   * Create the default tool map for the trade-failure demo.
   *
